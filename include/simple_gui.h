...
namespace simple_gui
{
    class simple_gui
    {
      public:
        ...
        void create_window(uint32_t p_width
                          ,uint32_t p_height
                          );

        inline
        uint32_t get_color_code(uint8_t r
                               ,uint8_t g
                               ,uint8_t b
                               );
        ...
        void set_pixel(uint32_t p_x
                      ,uint32_t p_y
                      ,uint32_t p_color
                      );

        inline
        void set_pixel_without_lock(uint32_t p_x
                                   ,uint32_t p_y
                                   ,uint32_t p_color
                                   );
        ...
        inline
        void set_rectangle_without_lock(const uint32_t & p_x
                                       ,const uint32_t & p_y
                                       ,const uint32_t & p_width
                                       ,const uint32_t & p_height
    ...
    //------------------------------------------------------------------------------
    uint32_t simple_gui::get_color_code(uint8_t r
                                       ,uint8_t g
                                       ,uint8_t b
                                       )
    {
    ...
    //------------------------------------------------------------------------------
    void simple_gui::set_pixel_without_lock(uint32_t p_x
                                           ,uint32_t p_y
                                           ,uint32_t p_color
                                           )
    {
    ...
    //------------------------------------------------------------------------------
    void simple_gui::set_rectangle_without_lock(const uint32_t & p_x
                                               ,const uint32_t & p_y
                                               ,const uint32_t & p_width
                                               ,const uint32_t & p_height
                                               ,const uint32_t & p_color
